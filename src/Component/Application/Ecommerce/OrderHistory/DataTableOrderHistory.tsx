        ...
        <Card>
          ...
          <CardBody> 
            <div className="order-history table-responsive custom-scrollbar">
              <DataTable
               data={filteredItems} columns={orderHistoryDataColumn}
                className="dataTables_wrapper no-footer" highlightOnHover noHeader pagination paginationServer  subHeaderComponent={subHeaderComponentMemo} />
            </div>
          </CardBody>
        </Card>
      </Col>
